  ...
  return <div className="min-h-screen bg-[radial-gradient(ellipse_70%_45%_at_50%_-10%,rgba(124,58,237,.15),transparent)]">
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-ink/80 backdrop-blur-xl">
      <div className="container-page flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-3 font-semibold tracking-tight"><span className="grid size-7 place-items-center rounded-md border border-white/15 bg-white/[0.06] text-xs">ZQ</span><span>Zeeshan Quraishy</span></Link>
    ...
    <main><Outlet /></main>
    <footer className="container-page mt-24 border-t border-white/[0.07] py-8 text-sm text-zinc-600"><div className="flex flex-col justify-between gap-2 sm:flex-row"><span>© {new Date().getFullYear()} Zeeshan Quraishy</span><span>Designed & engineered with care.</span></div></footer>
  </div>
}
